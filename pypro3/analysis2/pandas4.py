...
print(datas.head(2))
print(datas.tail(2))
cut2 = [0, 300, 600, 1000]  # 구간 기준 값

result_cut2 = pd.cut(datas, cut2)
print(result_cut2)

result_cut3 = pd.cut(datas, 3)  # 지정한 숫자만큼 범주화
print(result_cut3)
...
print(df.pivot('year', 'city', 'pop'))  # 구조를 재구성
print()
...
# 데이터를 요약하는 통계표이다. 이 요약에는 합계, 평균, 기타 통계가 포함될 수 있으며 피벗 테이블이 이들을 함께
# 의미있는 방식으로 묶어준다. 피벗 테이블은 데이터 처리의 한 기법이다.
