...
def age_category(age):
    ...
    return msg
df['Age_category'] = df['Age'].apply(lambda a:age_category(a))
# print(df.head(10))
...
# min_samples_leaf : 리프 노드 최소 샘플 수는 ?
# ...
...
print('RandomForestClassifier acc : {0:.5f}'.format(accuracy_score(y_test, bestPredict2)))  # 0.79330
