...
# A중학교 1학년 1반 학생들의 시험결과는 늘 80이라고 알려져 있다.
...
# print(data.describe())
print(stats.shapiro(data.국어))  # pvalue=0.012959 < 0.05 정규성 만족 X
...
print(np.mean(fdata.weight))  # 3132.4444444444443 vs 2800 차이?

# 정규성 확인
print(stats.shapiro(fdata.iloc[:,2]))  # pvalue=0.017984 정규성 만족 X
