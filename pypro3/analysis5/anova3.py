# data.go.kr 사이트에서 어느 음식점매출데이터와 날씨 데이터를 이용하여 온도높낮이에 따른 매출의 평균에 차이를 검정

# 온도가 더울 때, 보통일 때, 낮을 때의 매출액
...
# 등분산성
print(stats.levene(x1, x2, x3))  # pvale=0.03900 < 0.05 만족 X

# 정규성
print(stats.ks_2samp(x1, x2))
print(stats.ks_2samp(x1, x3))
print(stats.ks_2samp(x2, x3))  # 만족 X
...
# pvalue=2.360737101089604e-34 < 0.05 이므로 귀무가설기각. 매출액은 온도에 영향이 있다.
