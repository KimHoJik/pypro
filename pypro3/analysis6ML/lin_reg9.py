...
print('회귀계수(intercept) : ', lmodel.intercept_)  # 30.0988605396225
...
# 모델 성능 평가
print('RMSE : ', mean_squared_error(y, pred))  # 13.9898
print('r2_score : ', r2_score(y, pred))  # 0.6024  60% 정도의 설명력

print()
# 새로운 데이터로 예측
new_hp = [[110]]
new_pred = lmodel.predict(new_hp)
print('%s 마력인 경우 예상연비는 약 %s입니다.'%(new_hp[0][0], new_pred[0]))
