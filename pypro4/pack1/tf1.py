...
print(1, type(1))
print([1], type([1]))
print(tf.constant(1), type(tf.constant(1)))  # scalar : 0_D tensor
print(tf.constant([1]))  # vector : 1_D tensor
print(tf.constant([[1]]))  # matrix : 2_D tensor
